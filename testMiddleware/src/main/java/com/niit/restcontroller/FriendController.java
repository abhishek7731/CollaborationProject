...
User fromId= userDAO.getUser(email); //WE ARE PASSING THE EMAIL ID OF LOOGEDINUSER TO FROMID
Friend friend = new Friend();
friend.setFromId(fromId);//USER ID OF LOGGEDINUSER
friend.setToId(friendRequestToId);//friendRequestToId YEH HUMLOGO KO FRONTEND SA MILEGA
friend.setStatus('P');
...
@RequestMapping(value="/acceptrequests", method=RequestMethod.PUT)
...
@RequestMapping(value="/deleterequests", method=RequestMethod.PUT)
